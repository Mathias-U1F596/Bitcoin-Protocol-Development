"""
Bitcoin Developer Program
Task 3

Look at example_test.py in the functional test directory and try getting node
1 to mine another block, send it to node 2, and check that node 2 received it.
In your response to this email, please include a link to a gist or code
snippet that you used to complete this step.
"""
...
class MineABlockAndSendItToAnotherNodeTest(BitcoinTestFramework):
...
if __name__ == '__main__':
    MineABlockAndSendItToAnotherNodeTest().main()
